...
export default function NavbarDropdown({ title, entity }) {
  return (
    <li className="group relative flex justify-center">
      ...
      <div className="invisible absolute top-[150%] z-50 flex flex-col gap-2 rounded-xl border border-(--color-border) bg-(--color-surface) px-4 py-3 text-center text-light opacity-0 shadow-lg shadow-(color:--color-shadow) transition-all duration-300 group-hover:visible group-hover:opacity-100">
